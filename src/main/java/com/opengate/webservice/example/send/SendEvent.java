 ...
 * </p>
 * <p>
 * <b>Description:</b><br/> A simple example about event sending over OpenGate
...
public class SendEvent {
	public static void main(String[] args) throws Exception {
		...
		header.setOpType(OpTypeType.VALUE_122);
		header.setOpName("EXAMPLE_WS_EVENT");
		...
		notification.setDestinationArrival(true);
		...
		String xmlResponse = service.sendEvent(role, login, passwd, channel,
