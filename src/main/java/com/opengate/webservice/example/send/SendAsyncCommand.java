 ...
 * </p>
 * <p>
 * <b>Description:</b><br/> A simple example about asynchronous command
 * sending over OpenGate WebService Connector.
 * </p>
 * <p>
...
public class SendAsyncCommand {
	public static void main(String[] args) throws Exception {
		...
		// Operation type COMMAND= 121
		header.setOpType(OpTypeType.VALUE_121);
		header.setOpName("EXAMPLE_WS_ASYNC_COMMAND");
		header.setTransactionId((int) System.currentTimeMillis());
		...
		String xmlResponse = service.sendAsyncCommand(role, login, passwd,
				channel, organization, xmlRequest);
		if (xmlResponse != null) {
