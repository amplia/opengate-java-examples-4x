 ...
 * </p>
 * <p>
 * <b>Description:</b><br/> A simple example about response sending over
...
public class SendResponse {
	public static void main(String[] args) throws Exception {
		...
		// Operation Type RESPONSE= 123
		header.setOpType(OpTypeType.VALUE_123);
		header.setOpName("EXAMPLE_RESPONSE");
		header.setTransactionId((int) System.currentTimeMillis());
		header.setIdentifier(target);
		// Output connector type TCP= 2
		...
		String xmlResponse = service.sendResponse(role, login, passwd, channel,
				organization, xmlRequest);
		if (xmlResponse != null) {
